<template>
    <nav class="nav-bar">
        ...
        <div class="right">
            <div class="icon-box" v-if="!isMobile">
                <svg width="35" height="35" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
                ...
                <h2 class="menu-item-text" v-if="isDesktop">Home</h2>
            </div>
            <div class="icon-box" v-if="!isMobile">
                <svg width="35" height="35" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
                ...
                <h2 class="menu-item-text" v-if="isDesktop">Portfolio</h2>
            </div>
            <div class="icon-box" v-if="!isMobile">
                <svg width="35" height="35" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
                ...
                <h2 class="menu-item-text" v-if="isDesktop">Hire Me</h2>
            </div>
            <div class="icon-box" v-if="!isMobile">
                <svg width="35" height="35" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
                ...
                <h2 class="menu-item-text" v-if="isDesktop">Contact</h2>
            </div>

            <div class="hamburger-wrapper">
                <svg class="hamburger-icon" id="hamburger-menu" v-if="isMobile"
